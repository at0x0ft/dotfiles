...
readonly add_directive_to_zshrc="${CURRENT_ROOT}/available/shell/link/rc/external/add-directive.sh"
readonly add_directive_to_zshenv="${CURRENT_ROOT}/available/shell/link/env/add-directive.sh"
...
printf "${INIT_DIRECTIVE}\n" >> "${RC_PATH}"
printf "${THEME_DIRECTIVE}\n" >> "${RC_PATH}"
printf "${COMPLETION_DIRECTIVE}\n" >> "${RC_PATH}"
printf "${PLUGIN_DIRECTIVE}\n" >> "${RC_PATH}"
