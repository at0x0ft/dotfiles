...
deploy() {
  ...
  local readonly env_deploy="${SCRIPT_ROOT}/env/${DEPLOY_SCRIPT_NAME}"
  local readonly profile_deploy="${SCRIPT_ROOT}/profile/${DEPLOY_SCRIPT_NAME}"
  local readonly rc_deploy="${SCRIPT_ROOT}/rc/${DEPLOY_SCRIPT_NAME}"
